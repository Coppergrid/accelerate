...
public class MaglevBogeyRenderer implements BogeyRenderer {
    @Override
    ...
    public static class Small extends MaglevBogeyRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
    ...
    public static class Large extends MaglevBogeyRenderer {
