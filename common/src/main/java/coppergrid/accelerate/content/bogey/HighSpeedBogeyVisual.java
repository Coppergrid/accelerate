...
public class HighSpeedBogeyVisual implements BogeyVisual {
    private final TransformedInstance shaft1;
    private final TransformedInstance shaft2;

    public HighSpeedBogeyVisual(VisualizationContext ctx, float partialTick, boolean inContraption) {
    ...
    public static class Small extends HighSpeedBogeyVisual {
    ...
    public static class Large extends HighSpeedBogeyVisual {
        ...
        public void update(CompoundTag bogeyData, float wheelAngle, PoseStack poseStack) {
            ...
            drive.setTransform(poseStack)
                    .scale(1 - 1/512f)
                    .setChanged();
            belt.offset(0, HighSpeedBogeyRenderer.Large.BELT_RADIUS_IN_UV_SPACE * Mth.DEG_TO_RAD * wheelAngle)
