...
public class HighSpeedBogeyRenderer implements BogeyRenderer {
    @Override
    ...
    public static class Small extends HighSpeedBogeyRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
    ...
    public static class Large extends HighSpeedBogeyRenderer {
